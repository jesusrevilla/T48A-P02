...
Original file is located at
    https://colab.research.google.com/drive/1X0JEKgxyhuhkWfhOB0aIEbdOhEEofezw
...
def rand_int():
  ...
  '''
  return np.random.randint(1, 100, 10)
...
def matrix_diagonals(matrix):
  ...
  return (np.diag(matrix), np.diag(np.fliplr(matrix)))
